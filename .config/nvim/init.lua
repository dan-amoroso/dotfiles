  ...
  { -- Adds git related signs to the gutter, as well as utilities for managing changes
    ...
    opts = {
      ...
      on_attach = function(bufnr)
        ...
        map('n', '<leader>hr', gitsigns.reset_hunk, { desc = 'Git [h]unk [r]eset (undo)' })
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>lt', vim.lsp.buf.type_definition, '[L]SP [T]ype Definition')
          map('<leader>ls', vim.lsp.buf.document_symbol, '[L]SP [S]ymbols')
          map('<leader>lS', vim.lsp.buf.workspace_symbol, '[L]SP [S]earch Symbols')
